...
//	//}
//	if len(cmd) == 2 {
//		var singletonSection []byte
//		switch string(cmd[1]) {
//		case "server":
//			singletonSection = []byte(s)
//		case "client":
//			singletonSection = []byte(c)
//		case "cluster":
//			singletonSection = []byte(cl)
//		case "keyspace":
//			singletonSection = []byte(k)
//		default:
//		}
//		return RESP.MakeBulkData(singletonSection)
//	}
//
//	return RESP.MakeBulkData([]byte(s + "\n" + c + "\n" + cl + "\n" + k))
//}
//
